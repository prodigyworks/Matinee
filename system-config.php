...
// 	    	}
	...
	class SessionManagerClass {
		public static function initialise() {
		    ...
		    SessionManagerClass::initialiseDB();
			SessionManagerClass::initialisePageData();
...
//					echo "<script>document.title = 'Horizon Staff Database';</script>\n";
		...
		$(document).ready(function() {
			...
			function viewDocument(headerid, callback, id, table, key) {
				...
				if (table) {
					...
					parameters += "&table=trainingdeliverydocs&key=trainingdeliveryid";
				}
